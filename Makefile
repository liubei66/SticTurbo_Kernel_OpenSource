# Stic-Server-Makefile
# Stic/ADD - Linux 4.9.235-4.9.236-rc1-4.9.236
VERSION = 4
PATCHLEVEL = 9
SUBLEVEL = 236
# Stic/end ADD
# SUBLEVEL = 235
EXTRAVERSION =
STICNAME=20200907-dev
TRANCH=miui-q-dev-20200907
BRANCH=LA.UM.8.3.r1-08500-sdm845.0-miui-q-0907-all-rebase377
SVERSION=tag-rebase-0907
# CLANG=
# GCC=
NAME = Roaring Lionus
