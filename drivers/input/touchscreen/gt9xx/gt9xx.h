...
struct goodix_ts_platform_data {
	...
	bool use_default_cfg;
	u32 default_sensor_id;
...
struct goodix_ts_data {
	...
	bool force_update;
	bool init_done;
	u8 lockdown_info[GTP_LOCKDOWN_INFO_SIZE];
	u8 current_index;
	u16 pre_touch;
...
#define GTP_DEFAULT_INT_TRIGGER	 0x2008 /* 1 rising, 2 falling */
...
/**************************PART3:OTHER define*******************************/
#define GTP_DRIVER_VERSION	"V2.8.0.2<2017/12/24>"
...
#define GTP_REG_LOCKDOWN_INFO	0x81A0
...
/******************************End of Part III********************************/
#ifdef CONFIG_OF
extern int gtp_parse_dt_cfg(struct device *dev, u8 *cfg, int *cfg_len, char *cfg_name);
#endif
