...
/* Tunables */
static const int sync_read_expire = 480;	/* max time before a read sync is submitted. */
static const int sync_write_expire = 560;	/* max time before a write sync is submitted. */
static const int async_read_expire = 320;	/* ditto for read async, these limits are SOFT! */
static const int async_write_expire = 480;	/* ditto for write async, these limits are SOFT! */
...
MODULE_AUTHOR("Joe bfq-sq");
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("BFQ-SQ I/O Scheduler");
MODULE_VERSION("1.0");
