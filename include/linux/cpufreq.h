...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_REALMEUTIL)
extern struct cpufreq_governor cpufreq_gov_realmeutil;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_realmeutil)
#endif
